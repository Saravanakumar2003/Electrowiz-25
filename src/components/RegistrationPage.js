...
const RegistrationPage = () => {
  ...
  return (
    ...
    //   <ToastContainer />
    //   <h2 className='Headings'>Registration is Closed</h2>
    // </div>
    <div className="registration-form">
      <ToastContainer />
      <h2 className='Headings'>Event Registration Form</h2>
      <p className='Headings2'>This is a sample form (The actual event is already over)</p>
      <form id="msform">
        <ul id="progressbar">
        ...
        {currentStep === 3 && (
          <fieldset>
            ...
            <label>Click on the "Pay Now" button to proceed with the payment. (This is a dummy gateway, you don't need any real money to pay)</label>
            <br />
