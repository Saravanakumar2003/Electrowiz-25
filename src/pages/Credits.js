    ...
    return (
        <div className="credits">
            ...
            <div className="credit_box">
                ...
                <div className="credit_inner_box">
                    <h3>Dr. K. Lavanya</h3>
                    <span>Assitant Professor, ECE</span>
                </div>
                <div className="credit_inner_box">
                    <h3>Dr. S. Manju</h3>
                    <span>Assitant Professor, ECE</span>
            ...
            <div className="credit_box">
                ...
                <div className="credit_inner_box">
                    <h3>Harsha Vardhini</h3>
                    <span>Linked Up</span>
                </div>  
                <div className="credit_inner_box">
                    <h3>Dhesvanth</h3>
                    <span>Mystery Matters</span>
                </div>  
                <div className="credit_inner_box">
                    <h3>Musharaf</h3>
                    <span>Mystery Matters</span>
